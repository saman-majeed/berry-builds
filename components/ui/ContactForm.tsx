...
export default function ContactForm() {
  ...
  return (
    <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-[1.4fr_1fr] lg:gap-12">
      {/* Form */}
      <div className="rounded-2xl border border-border bg-surface p-8 shadow-[0_20px_60px_rgba(0,0,0,0.35)] ring-1 ring-white/[0.04]">
        {success ? (
          ...
          <>
            ...
            <button onClick={submit} disabled={loading} className="btn-primary mt-6 w-full cursor-pointer border-0 py-3 text-[0.95rem] disabled:cursor-not-allowed disabled:opacity-60">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
        <div className="rounded-xl border border-border bg-surface p-6 ring-1 ring-white/[0.03]">
        ...
        <div className="rounded-xl border border-accent/25 bg-gradient-to-br from-accent/10 to-transparent p-5 text-center ring-1 ring-accent/20">
